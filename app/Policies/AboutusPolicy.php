...
class AboutusPolicy
{
    ...
    {
        return $user->checkPermissionAccess(config('permissions.access.aboutUs'));
    }
    ...
    //  * @return mixed
    //  */
    public function restore(User $user, Aboutus $blog_category)
    {
        //
    }
    ...
    //  * @return mixed
    //  */
    public function forceDelete(User $user, Aboutus $blog_category)
    {
        //
    }
}
