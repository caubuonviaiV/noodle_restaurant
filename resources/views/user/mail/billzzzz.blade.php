                ...
                <div class="container-fluid">
                    ...
                    <div class="row mt-5" style="margin-top: 35px; display: flex;">
                        {{-- <div class="col-6"
                            ...
                            <br>
                            <span>
                                <a style="color: white !important;" href="mailto:{{ $cutomers->email }}" target="_blank">{{ $order->email }}</a>
                            </span>
                            <br>
                            <span>{{ $cutomers->phone }}</span>
                        </div>
                        <div class="col-6" style="flex: 0 0 50%; width: 50%; box-sizing: border-box;">
                            <b>Order date:</b> {{ date('d/m/yy H:i', strtotime($cutomers->created_at)) }}
                            <br>
                            <b>Address:</b> {{ $cutomers->address }}
                        </div> --}}
                    </div>
                </div>
            </div>
...
{{-- 
                        @if($cutomers->payment_type == "pay_later")
                        ...
                        @if($cutomers->payment_type == "online_payment")
                            <td class="pl-3" style=" padding-left:15px;">
                                <span class="d-inline"
                                      style="color:#424853; font-family:trebuchet,sans-serif; font-size:16px; font-weight:normal; line-height:22px;">
                    ...
                    <div class="row pl-3 py-2" style="background-color: #fff; padding: 10px 20px 10px 20px;">
                        <table class="table table-sm table-hover"
                            ...
                            <tr>
                                ...
                                <th style="padding: 5px 20px 5px 0; text-align: right;">Chi tiết thanh toán</th>
                            </tr>
                            </thead>
                            <tbody>
                            {{-- @foreach($cutomers->carts as $cart)
                                <tr>
                                    <td style="border-top: 1px solid #dee2e6; padding: 5px 0;">
                                        {{ $cart->products->name . ' (x' . $cart->qty . ')'}}
                                    </td>
            ...
            <div class="row mt-2 mb-4" style="margin-top: 15px; margin-bottom: 25px;">
                <div class="container-fluid">
                    ...
                    <div class="row pl-3 py-2" style="background-color: #fff; padding: 10px 20px;">
                        <p>Quý khách có thể kiểm tra hình thức bên ngoài thực phẩm (chất lượng, màu sắc, số lượng, ...) trước khi thanh toán và có thể từ chối nhận hàng nếu không hài lòng.</p>

                        <p>Nếu sản phẩm có dấu hiệu hư / hỏng hoặc không đúng với thông tin trên website, 
                            vui lòng liên hệ cửa hàng trong vòng 48h kể từ khi nhận hàng để được hỗ trợ.</p>
                        <b>Bà Mua cảm ơn bạn.</b>
                    </div>
                </div>
            </div>
