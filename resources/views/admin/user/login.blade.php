...
<html>
    <head>
        ...
        <link rel="stylesheet" href="https://unpkg.com/tailwindcss@^2/dist/tailwind.min.css" type="text/css" media="screen" title="no title" charset="utf-8" />
    </head>
    <body class>
        <div class="lg:flex">
            <div class="lg:w-1/2 xl:max-w-screen-sm">
                ...
                <div class="mt-10 px-12 sm:px-24 md:px-48 lg:px-12 lg:mt-16 xl:px-24 xl:max-w-2xl">
                    ...
                    xl:text-bold">Đăng nhập <br>Hệ thống quản trị</h2>
                    <div class="mt-12">
                        @include('admin.alert')
                        <form class="row g-1 p-3 p-md-4" action="/loginadmin/store"  method="POST">
                            <div>
                                <div class="text-sm font-bold text-gray-700 tracking-wide">Địa chỉ Email</div>
                                <input name="email" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="ten@gmail.com">
                            </div>
                            <div class="mt-8">
                                <div class="text-sm font-bold text-gray-700 tracking-wide">Mật khẩu </div>
                                <input name="password" type="password" class="w-full text-lg py-2 border-b border-gray-300 focus:outline-none focus:border-indigo-500" type="" placeholder="Nhập mật khẩu của bạn">
                            </div>
                            <br>
                            <div class="col-12">
                                <div class="form-check">
                                    <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" name="remember" checked>
