...
<?php $__env->startSection('content'); ?>
    ...
    <div class="body d-flex py-lg-3 py-md-2">
        <div class="container-xxl">
                                ...
                                <tbody>
                                    <?php $__currentLoopData = $roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            ...
                                            <td>
                                                <button type="button" value="<?php echo e($role->id); ?>"
            ...
            <?php echo $__env->make('admin.role.add', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo $__env->make('admin.role.edit', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php echo $__env->make('admin.role.delete', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('.update_data').on('click', function(e) {
                ...
                var url = '<?php echo e(route('role.update', ':id')); ?>';
                url = url.replace(':id', id);
            ...
            $('.delete_data').on('click', function(e) {
                ...
                var url = '<?php echo e(route('role.destroy', ':id')); ?>';
                url = url.replace(':id', id);
                $.ajax({
                    type: "DELETE",
                    url: url,
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dntru\OneDrive\document\Web\Laravel\webmiquang_laravel\resources\views/admin/role/index.blade.php ENDPATH**/ ?>