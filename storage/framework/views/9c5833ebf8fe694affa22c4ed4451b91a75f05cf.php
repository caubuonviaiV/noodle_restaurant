    ...
    <div class="container">
        ...
        <table width="100%" style="border-collapse: collapse;">
            <tr>
                <td widdth="50%" style="background:#eee;padding:20px;">
                    <strong>Ngày đặt:</strong> <?php echo e(date('d/m/Y-H:m', strtotime($transaction->created_at))); ?><br>
        ...
        <table width="100%" style="border-collapse: collapse;border-bottom:1px solid #eee;">
            ...
            <tr>
                ...
                <td class="row"><span style="color:#777;font-size:11px;"><?php echo e($i+1); ?></span></td>
                <td class="row">
                    <img alt="img error" src="<?php echo e(public_path($cart->product->thumb)); ?>" style="width: 120px; height: 70px; margin-bottom: 4px">
                    <br>
                    <?php echo e($cart->product->name); ?>

                </td>
                <td class="row"><?php echo e(number_format($cart->total_price, 0, '', '.')); ?>đ <span style="color:#777">X</span> <?php echo e($cart->total_item); ?></td>
                <td class="row"><?php echo e(number_format($price, 0, '', '.')); ?>đ</td>
            </tr>
...
<?php /**PATH C:\Users\dntru\OneDrive\document\Web\Laravel\webmiquang_laravel\resources\views/admin/transactions/pdf.blade.php ENDPATH**/ ?>