        ...
        <tbody>
            <tr>
                ...
                <td class="container"
                    ...
                    <div class="content"
                        style="box-sizing: border-box; display: block; max-width: 600px; margin: 0 auto; padding: 10px;">
                        <span class="preheader"
                            style="color: transparent; display: none; height: 0; max-height: 0; max-width: 0; opacity: 0; overflow: hidden; mso-hide: all; visibility: hidden; width: 0;">Let's
                            confirm your email address.</span>
                        <div class="header"
                            style="box-sizing: border-box; width: 100%; margin-bottom: 30px; margin-top: 15px;">
                            <table
                                    ...
                                    <tr>
                                        <td align="left" class="align-left"
                                            ...
                                            valign="top"><span class="sg-image"
                                                data-imagelibrary="<?php echo e(asset('teamplate/img/logo1.png')); ?>"><a
                                                    href=""
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td align="center" bgcolor="#348eda"
                                                                                            ...
                                                                                            <a href="<?php echo e(route('register.verify', ['id' => $user->id, 'token' => $user->remember_token])); ?>"
                                ...
                                <tbody>
                                    <tr style="font-size: 12px;">
                                        <td align="center" class="align-center"
                                            ...
                                            valign="top">
                                            <span class="sg-image"
                                                data-imagelibrary="<?php echo e(asset('teamplate/img/logo1.png')); ?>"
                                                ...
                                                <a href="#"
                                                    ...
                                                    <img alt="logo" height="16"
                                                        src="<?php echo e(asset('teamplate/img/logo1.png')); ?>"
...
<?php /**PATH C:\Users\dntru\OneDrive\document\Web\Laravel\webmiquang_laravel\resources\views/user/mail/confirmRegistration.blade.php ENDPATH**/ ?>