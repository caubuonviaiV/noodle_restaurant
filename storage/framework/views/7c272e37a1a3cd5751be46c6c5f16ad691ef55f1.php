                    ...
                    <form action="<?php echo e(route('products.update', ['product'=> $product->id])); ?>" method="POST">
                            ...
                            <div class="col-md-6">
                                ...
                                <select class="form-select" name="cat_id">
                                    ...
                                    <?php $__currentLoopData = $product_categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <option value="<?php echo e($category->id); ?>" <?php echo e($product->cat_id == $category->id ? 'selected' : ''); ?>><?php echo e($category->name); ?></option>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <input type="number" name="price" value="<?php echo e($product->price); ?>" class="form-control price">
                            </div>

                            <div class="col-md-6">
                                <label class="form-label">Giá giảm</label>
                                <input type="number" name="price_sale" value="<?php echo e($product->price_sale); ?>" class="form-control price">
                            </div>
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            placeholder="Nội dung mô tả"> <?php echo e($product->description); ?> </textarea>
                        </div>

                        <div class="mb-3">
                            <label class="form-label">Mô tả chi tiết</label>
                            <textarea class="form-control" name="content" id="content" rows="3"
                                placeholder="Nội dung mô tả chi tiết"> <?php echo e($product->content); ?> </textarea>
                        </div>
...
<?php echo $__env->make('admin.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dntru\OneDrive\document\Web\Laravel\webmiquang_laravel\resources\views/admin/products/edit.blade.php ENDPATH**/ ?>