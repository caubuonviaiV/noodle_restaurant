            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-6 col-md-8" data-cue="slideInUp">
                    <div class="main_title">
                        <span><em></em></span>
                        <h2>Đặt bàn</h2>
                        <?php $__currentLoopData = $aboutus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $abu): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <p>hoặc gọi điện cho chúng tôi theo số <?php echo e($abu->phone); ?></p>
                    ...
                    <div id="wizard_container">
                        <form action="" method="POST" id="frmtuvan">
                            ...
                            <div id="middle-wizard">
                                ...
                                <!-- /step 1-->
                                <div class="step">
                                    <h3 class="main_question"><strong>2/3: </strong>Vui lòng chọn thời gian và sô người đến</h3>
                                ...
                                <div class="submit step">
                                    ...
                                    <div class="form-group">
                                        <input type="text" name="name"  value="<?php echo e(Auth::user()->name); ?>" class="form-control required" placeholder="Họ và Tên">
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <input type="email" name="email"  value="<?php echo e(Auth::user()->email); ?>" class="form-control required" placeholder="Email của bạn">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <input type="number" name="phone"  value="<?php echo e(Auth::user()->phone); ?>" id="txtphone" class="form-control required" placeholder="Số điện thoại">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
...
<?php echo $__env->make('user.layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\dntru\OneDrive\document\Web\Laravel\webmiquang_laravel\resources\views/user/reservation/index.blade.php ENDPATH**/ ?>